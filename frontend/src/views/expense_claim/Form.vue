...
const advances = createResource({
	url: "oims.hr.doctype.expense_claim.expense_claim.get_advances",
...
const expenseApproverDetails = createResource({
	url: "oims.api.get_expense_approval_details",
	params: { employee: employee.data.name },
	onSuccess(data) {
...
const companyDetails = createResource({
	url: "oims.api.get_company_cost_center_and_expense_account",
