	...
	<ion-page>
		<ion-content :fullscreen="true">
			...
			<Dialog v-model="showDeleteDialog">
				<template #body-title>
					<h2 class="text-xl font-bold">Hazard Report</h2>
				</template>
				<template #body-content>
					<p>
						Are you sure you want to delete the Hazard Report
...
const doctype = "Hazard Report"
const redirectToName = "HazardReports"
