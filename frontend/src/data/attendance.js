...
export const myAttendanceRequests = {
	data: [],
	loading: false,
	error: null,
	async reload() {
...
// 	auto: true,
// 	cache: "oims:attendance_requests",
// 	transform: (data) => {
...
// 	url: "oims.api.get_shift_requests",
// 	params: {
// 		employee: employeeResource.data.name,
// 		limit: 10,
// 	},
// 	auto: true,
// 	cache: "oims:my_shift_requests",
// 	transform(data) {
// 		return transformShiftRequests(data)
// 	},
// })

export const teamShiftRequests = {
	data: [],
	loading: false,
	error: null,
	async reload() {
...
// 	},
// 	auto: true,
// 	cache: "oims:team_shift_requests",
// 	transform(data) {
// 		return transformShiftRequests(data)
// 	},
// })
